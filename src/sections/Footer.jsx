...
export default function Footer() {
    ...
    return (
        <footer id='footer' className='relative z-50 w-full flex justify-center items-center py-4 px-4 bg-transparent min-h-[25vh]'>
            <AnimatedBg />
            <div className='absolute top-0 left-0 h-full flex flex-row items-end justify-between px-8 py-4 w-full'>
                <h2 className=' text-lg font-primary'>&copy;Utools {year}</h2>
